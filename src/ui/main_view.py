...
class MainView:
    def __init__(self, root, handle_show_create_replace_data_view, handle_show_create_document_view, handle_show_delete_replace_data_view, handle_show_settings_view):
        self._root = root
    ...
    def _initialize(self):
        ...
        heading_label = ttk.Label(master=self._frame, text="Lisää / Poista täyttötietoja", font="TkHeadingFont 16 bold")
        ...
        heading_label5 = ttk.Label(master=self._frame, text="Asetukset", font="TkHeadingFont 12 bold")
        button4 = ttk.Button(master=self._frame, text="Asetukset", command=self._handle_show_settings_view, width=50)     
        ...
        heading_label5.grid(columnspan=2, sticky=constants.W, padx=5, pady=10)
        button4.grid(columnspan=2, sticky=(constants.W, constants.E), padx=5, pady=5)