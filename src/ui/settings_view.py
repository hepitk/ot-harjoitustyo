...
class SettingsView:
    ...
    def _handle_button_click(self):
        if self._change_font_name_entry.get() != "" and self._change_font_size_entry.get() != "":
            try:
                int(self._change_font_size_entry.get())
                if (document_handler.set_font(
                    self._change_font_name_entry.get(),
                    int(self._change_font_size_entry.get())
                    ) and self._change_font_name_entry.get() != ""
                    ):
                    self._font_name_variable.set(
                        "Asetettu fontti: " + self._change_font_name_entry.get()
                    )
                    self._font_size_variable.set(
                        "Asetettu fonttikoko: " + str(self._change_font_size_entry.get())
                    )
    ...
    def _initialize(self):
        ...
        self._font_name_label = ttk.Label(
            master=self._frame,
            textvariable=self._font_name_variable,
            font="font=TkHeadingFont 10 bold italic"
        )
        ...
        self._font_size_label = ttk.Label(
            master=self._frame,
            textvariable=self._font_size_variable,
            font="font=TkHeadingFont 10 bold italic"
        )
        ...
        self._font_name_label.grid(padx=5, pady=2, sticky=constants.W)

        self._font_size_label.grid(padx=5, pady=2, sticky=constants.W)

        change_font_name_label.grid(padx=5, pady=5)

        self._change_font_name_entry.grid(
            row=3,
            column=1,
        ...
        self._change_font_size_entry.grid(
            row=4,
            column=1,
            sticky=(constants.E, constants.W),
            padx=5,
        ...
        change_font_button.grid(columnspan=2, sticky=(constants.E, constants.W), padx=5, pady=5)

        back_button.grid(columnspan=2, sticky=(constants.E, constants.W), padx=5, pady=5)
