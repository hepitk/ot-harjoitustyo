...
class CreateReplaceDataView:
    ...
    def _handle_button_click(self):
        if (self._document_name_entry.get() != "" and
            self._user_input_data_entry.get() != "" and
            self._placeholder_entry.get() != "" and not
        ...
        elif program_service.placeholder_duplicate_exists(
                self._document_name_entry.get(),
                self._placeholder_entry.get()
            ):
    ...
    def _initialize(self):
        ...
        self._document_name_entry.grid(
            row=1,
            column=1,
        ...
        self._user_input_data_entry.grid(
            row=2,
            column=1,
            sticky=(constants.E, constants.W),
            padx=5,
        ...
        add_button.grid(columnspan=2, sticky=(constants.E, constants.W), padx=5, pady=5)
